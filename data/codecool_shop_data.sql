...
--
-- INSERT INTO product(product_name, default_price, currency, description, supplier_name, product_category_name) VALUES ('iPhone 13', '549.9', 'USD', 'Advanced 12MP dual camera system with ultra wide angle and wide angle lens', 'Apple', 'Phone');
-- INSERT INTO product(product_name, default_price, currency, description, supplier_name, product_category_name) VALUES ('Redmi Note 11', '322.9', 'USD', 'Faster, more responsive 6.1-inch Super Retina XDR display with ProMotion technology', 'Lenovo', 'Tablet');
-- INSERT INTO product(product_name, default_price, currency, description, supplier_name, product_category_name) VALUES ('Dell XPS', '1224.8', 'USD', 'The display has a resolution of 3K, a contrast ratio of 1000: 1 and 100% sRGB color coverage', 'Dell', 'Laptop');
--
